...
int avl::calcAltura(no *p){ //p = raiz em execução

    if((p->esquerdo) && (p->direito)){ //p diferente de NULL
...
int avl::bf(no *n){ //Índice de Balanceamento
            
    if((n->esquerdo) && (n->direito)){ //n diferente de NULL
